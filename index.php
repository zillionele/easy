...
<html>
<head>
<title>EASY_SHOP  RWANDA Online Shopping </title>
<!--/tags -->
...
<div class="header" id="home">
	<div class="container">
		<ul>
			...
			<blink><li> <a href="#" data-toggle="modal" data-target="#myModal2"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> partener with us</a></li><blink>
			<li><i class="fa fa-phone" aria-hidden="true"></i> Call : +250784694536</li>
			<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:info@example.com">Easyshop@gmail.com</a></li>
		</ul>
	</div>
</div>
<!-- //header -->
	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="index.html"><span>E</span>asy Shopy <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">Sign In <span>Now</span></h3>
							...
							<input type="submit1" value="Sign In">
						</form>
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2><a href="index.html"><span>E</span>asy Shop </a></h2>
				...
				<div class="col-md-5 sign-gd-two">
					...
					<div class="w3-address">
						...
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								<h6>Email Address</h6>
								<p>Email :<a href="mailto:example@email.com"> info@easyshop.com</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="w3-address-grid">
		...
		<p class="copy-right">&copy 2018 Easy Shop. All rights reserved | Design by <a href="http://w3layouts.com/">zillionele</a></p>
	</div>
</div>
<!-- //footer -->
								...
								<div class="login">
									<div class="login-bottom">
										...
										<div class="sign-up">
											...
											<div class="sign-up">
												<h4>Password :</h4>
												<input type="password" name="passwor" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">
												
											</div>
											<div class="sign-up">
												<h4>Re-type Password :</h4>
												<input  name="confirmapass" type="password" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">
